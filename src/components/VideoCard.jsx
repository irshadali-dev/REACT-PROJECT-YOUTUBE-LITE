    ...
    return (
        <Link to={`/video/${video?.videoId}`}>
            <div className="flex flex-col mb-8">
                ...
                h-48 md:h-40 md:rounded-xl 
                overflow-hidden">
                    <img className='h-full w-full object-cover ' alt='youtube-thumbnails' src={video?.thumbnails?.[0]?.url}
                    />
                    {video?.lengthSeconds &&
                        (
                ...
                <div className="flex text-white mt-3">
                    ...
                    <div className="flex flex-col ml-3 overflow-hidden">
                        ...
                        <div className="flex text-[12px] lg:text-[10px] font-semibold text-white/[0.7] truncate overflow-hidden">
